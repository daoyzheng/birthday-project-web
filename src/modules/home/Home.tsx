...
const Home = () => {
  ...
  return !isBirthday ? 
    (
      <>
      <div className={`bg-stone-900 min-h-screen flex items-center justify-center ${isInitializing ? 'opacity-100' : 'opacity-0 hidden'}`}>
      ...
      <div className={`${isInitializing ? 'opacity-0 hidden' : 'opacity-100'}`}>
        <Frame>
          <Canvas>
            <Meteor/>
            <Star/>
