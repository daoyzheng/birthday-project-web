...
const Home = () => {
  ...
  return !isBirthday ? 
    (
      <>
      <div className={`bg-stone-900 min-h-screen flex items-center justify-center absolute inset-0 ${isInitializing ? 'opacity-100' : 'opacity-0'}`}>
      ...
      <div className={`${isInitializing ? 'opacity-0' : 'opacity-100'}`}>
        <Frame>
          <Canvas>
            <Meteor/>
            <Star/>
